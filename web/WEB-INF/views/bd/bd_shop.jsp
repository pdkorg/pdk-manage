...
<div class="page-container">
              ...
              <div class="form-body">
                ...
                <div class="table-toolbar">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="btn-group">
                        <a id="new_order" class="btn btn-default" data-toggle="modal" data-target="#shopDialog">
                ...
                <table class="table table-striped table-bordered table-hover" id="bd-shop-table">
                  <thead>
                  <tr>
                    <th class="table-checkbox">
                      <input type="checkbox" class="group-checkable"
                             data-set="#bd-shop-table .checkboxes"/>
                    </th>
                    <th name="index">序号</th>
                    <th name="code">编码</th>
                    <th name="name">名称</th>
                    <th name="info">详细信息</th>
  ...
  <div class="modal fade" id="shopDialog" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="shopLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="shopLabel"><i class="fa fa-truck"></i> 商店信息</h4>
        </div>
        <div id="shopDetailPane" class="modal-body">
          <form id="shopDetailForm" action="bd/bd_shop" method="post">
            <input type="hidden" name="id" value="" />
            <div id='edit-method'>
            </div>
            <div class="form-group">
              <label class="control-label">编码：</label>
              <input type="text" name="code" class="form-control" maxlength="20" placeholder="请输入商店编码" />
            </div>
            <div class="form-group">
              <label class="control-label">名称：</label>
              <input type="text" name="name" class="form-control" maxlength="50" placeholder="请输入商店名称" />
            </div>
            <div class="form-group">
              <label class="control-label">详细信息：</label>
              <textarea type="text" name="info" class="form-control" maxlength="400"  style="max-width:100%;" rows=3  placeholder="" ></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea type="text" id="memo" name="memo" class="form-control" style="max-width:100%;" rows=4 placeholder="" ></textarea>
            </div>
          </form>
...
<form id="shopDelForm" action="bd/bd_shop" method="POST">
...
<form id="shopUpdateStatusForm" action="bd/bd_shop/status" method="POST">
...
<script src="<%=resourcePath%>static/admin/js/bd/bd_shop.js" type="text/javascript" charset="utf-8"></script>
