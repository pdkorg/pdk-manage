        ...
        <div class="col-md-12">
          ...
          <div class="portlet light bordered">
            <div class="portlet-title">
              <div class="caption">
                <i class="fa fa-user font-blue-sharp"></i><span class="caption-subject font-blue-sharp bold uppercase">用户信息</span>
              </div>
              <div class="actions">
              </div>
            </div>
              <div id="userDetailPane" class="modal-body">
                <form id="userDetailForm" action="sm/sm_user" method="post">
                  <div class="table-toolbar">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="btn-group">
                          <a id="edit_order" class="btn btn-default" onclick="editUserInfo()">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="typeName" name="typeName" class="form-control" value="${user.typeName}" readonly="true" />
                  </div>
                  <div class="form-group">
                    <label class="control-label">姓名：</label>
                    <input type="text" id="realName" name="realName" class="form-control" value="${user.realName}" readonly="true" />
                  </div>
                  <div class="form-group">
                    <label class="control-label">性别：</label>
                    <input type="text" id="sexName" name="sexName" class="form-control" value="${user.sexName}" readonly="true" />
                  </div>
                  <div class="form-group">
                    <label class="control-label">年龄：</label>
                    <input type="text" id="age" name="age" class="form-control mask_age" value="${user.age}" readonly="true"/>
                  </div>
                  <div class="form-group">
                    <label class="control-label">电话：</label>
                    <input type="text" id="phone" name="phone" class="form-control mask_phone" value="${user.phone}" readonly="true" />
                  </div>
                  <div class="form-group">
                    <label class="control-label">地址：</label>
                    <input type="text" id="address" name="address" class="form-control" value="${user.fullAddress}" readonly="true" />
                  </div>
                  <div class="form-group">
                    <label class="control-label ">状态：</label>
                    <input type="text" id="statusName" name="statusName" class="form-control" value="${user.statusName}" readonly="true" />
                  </div>
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="input-group">
                        <input type="text" name="unRegisterTimeStr" value="${user.unRegisterTimeStr}" class="form-control" readonly >
                      </div>
                    </div>
                  </div>
                </form>
