          ...
          <div class="portlet light bordered">
            <div class="portlet-title">
              <div class="caption">
                ...
                <span class="caption-subject font-blue-sharp bold uppercase">优惠券活动模板编辑</span>
              </div>
              <div class="tools">
              </div>
            </div>
                ...
                <form id="activityDetailForm" action="coupon/coupon_activity_template_detail" method="POST">
                  ...
                  <div class="row">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="code" class="form-control" maxlength="20" value="${activityTemplate.code}" maxlength="20" placeholder="请输入活动模板编码" />
                    </div>
                    <div class="form-group col-md-6">
                      <label class="control-label">模板名称：</label>
                      <input type="text" name="name" class="form-control" value="${activityTemplate.name}" maxlength="50" placeholder="请输入活动模板名称"/>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-md-6">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      ...
                      <textarea type="text" name="memo" class="form-control" style="max-width:100%;" rows=3 maxlength="400">${activityTemplate.memo}</textarea>
                    </div>
                  </div>
                </form>
                <!-- END FORM HEAD -->
                    ...
                    <table class="table table-striped table-bordered" id="coupon-table">
                      <thead>
                        <tr>
                          ...
                          <th name="flowType" style="width:170px">优惠券类型</th>
                          <th name="sendMny" style="width:90px">发放金额</th>
                          <th name="minPayMny" style="width:90px">最低消费金额</th>
                          <th name="delayDays" style="width:90px">延迟生效天数</th>
                          <th name="actDays" style="width:90px">有效天数</th>
                          <th name="beginDate" style="width:270px">生效开始日期</th>
                          <th name="endDate" style="width:270px">生效截止日期</th>
                          <th name="memo" style="min-width: 100px;">备注</th>
                        </tr>
                      </thead>
                      <tbody>
                      </tbody>
