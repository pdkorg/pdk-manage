        ...
        <div class="col-md-12">
          ...
          <div class="portlet light bordered">
            <div class="portlet-title">
              <div class="caption">
                <i class="fa fa-list"></i>优惠券活动模板列表
              </div>
              <div class="tools">
            ...
            <div class="portlet-body">
              <div class="form-body">
                ...
                <table class="table table-striped table-bordered table-hover" id="template-table">
                  <thead>
                  <tr>
                    <th class="table-checkbox">
                      <input type="checkbox" class="group-checkable"
                             data-set="#template-table .checkboxes"/>
                    </th>
                    <th name="index">序号</th>
                    <th name="code">活动模板编码</th>
                    <th name="linkName">活动模板名称</th>
                    <th name="statusName">活动模板状态</th>
                    <th name="memo">备注</th>
                  </tr>
                  </thead>
                  <tbody>
...
<form id="templateDelForm" action="coupon/coupon_activity_template" method="POST">
  <input type="hidden" name="_method" value="DELETE"/>
  <div id="id-data">
  </div>
</form>

<form id="tmpUpdateStatusForm" action="coupon/coupon_activity_template/status" method="POST">
...
<script src="<%=resourcePath%>static/admin/js/coupon/coupon_activity_template.js" type="text/javascript" charset="utf-8"></script>
