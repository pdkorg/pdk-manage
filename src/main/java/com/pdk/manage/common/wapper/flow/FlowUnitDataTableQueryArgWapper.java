 ...
 */
public class FlowUnitDataTableQueryArgWapper extends AbstractDataTableQueryArgWapper {
    @Override
    public List<String> getColNameList() {
            return Arrays.asList("", "id", "code", "name", "orderStatus", "flowActionCode" , "status");
    }
}
